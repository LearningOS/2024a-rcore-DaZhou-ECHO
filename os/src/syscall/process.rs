...
use alloc::vec::Vec;
use alloc::sync::Arc;
// crate::task::task::TaskControlBlockInner;
use crate::task::{
    TaskContext,
    TaskStatus,
    TaskControlBlock,
...
// use crate::task::{get_current_task_status,get_current_task_time_cost,get_current_task_syscall_times};
...
pub fn sys_mmap(start: usize, len: usize, port: usize) -> isize {
    ...
    start >= MAXVA /* mapping range should be an legal address */ {return -1;}
